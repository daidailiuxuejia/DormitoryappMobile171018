 ...
 */
public class DormListViewActivity extends Activity implements OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dorm_list);
		myApp =  (MyApp) DormListViewActivity.this.getApplication();
		keyword = DormListViewActivity.this.getIntent().getStringExtra("keyword");
		...
		adapter =  new DormListViewAdapter(DormListViewActivity.this);
...
//		loadingGoodsListData(null);
	...
	private void ShowSureDialog(final String roomid) {
		final AlertDialog alertDialog = new AlertDialog.Builder(DormListViewActivity.this)
				.setTitle("确认信息")
				.setMessage("确认取消本次预定？")
...
//					JSONObject obj = new JSONObject(json);
					...
					if(arrlist.equals("1")){
						Toast.makeText(DormListViewActivity.this, "取消成功", Toast.LENGTH_LONG).show();
						loadingGoodsListData();
					}
					}else{
					}
			...
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(DormListViewActivity.this, result, Toast.LENGTH_SHORT).show();;
		} catch (IOException e) {
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(DormListViewActivity.this, result, Toast.LENGTH_SHORT).show();;
