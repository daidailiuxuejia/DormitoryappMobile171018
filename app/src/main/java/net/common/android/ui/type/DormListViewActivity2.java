 ...
 */
public class DormListViewActivity2 extends Activity implements OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dorm_list2);
		myApp =  (MyApp) DormListViewActivity2.this.getApplication();
		keyword = DormListViewActivity2.this.getIntent().getStringExtra("keyword");
		...
		adapter =  new DormListViewAdapter(DormListViewActivity2.this);
...
//		loadingGoodsListData(null);
		...
		goodsListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				Dormitory bean = (Dormitory) goodsListView
						.getItemAtPosition(arg2);
				Intent intent =new Intent(DormListViewActivity2.this,StudentListViewActivity3.class);
				Bundle b = new Bundle();
				b.putString("dormitory_no", bean.getId());
				intent.putExtras(b);
	...
	private void ShowSureDialog(final String roomid) {
		final AlertDialog alertDialog = new AlertDialog.Builder(DormListViewActivity2.this)
				.setTitle("确认信息")
				.setMessage("确认取消本次预定？")
...
//					JSONObject obj = new JSONObject(json);
					...
					if(arrlist.equals("1")){
						Toast.makeText(DormListViewActivity2.this, "取消成功", Toast.LENGTH_LONG).show();
					}
					}else{
					}
			...
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(DormListViewActivity2.this, result, Toast.LENGTH_SHORT).show();;
		} catch (IOException e) {
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(DormListViewActivity2.this, result, Toast.LENGTH_SHORT).show();;
	...
	public void loadingGoodsListData(String key){
	
		String url = null;
		try {
			url = HttpUtil.URL_DORMLST+"?number="+URLEncoder.encode(key, "utf-8");
