 ...
 */
public class DormListViewActivity4 extends Activity implements OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dorm_list4);
		myApp =  (MyApp) DormListViewActivity4.this.getApplication();
		keyword = DormListViewActivity4.this.getIntent().getStringExtra("keyword");
		...
		adapter =  new DormListViewAdapter(DormListViewActivity4.this);
...
//		loadingGoodsListData(null);
		...
		goodsListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				Intent intent =new Intent(DormListViewActivity4.this,StudentListViewActivity3.class);
				Bundle b = new Bundle();
	...
	private void ShowSureDialog(final String roomid) {
		final AlertDialog alertDialog = new AlertDialog.Builder(DormListViewActivity4.this)
				.setTitle("确认信息")
				.setMessage("确认取消本次预定？")
...
//					JSONObject obj = new JSONObject(json);
					...
					if(arrlist.equals("1")){
						Toast.makeText(DormListViewActivity4.this, "取消成功", Toast.LENGTH_LONG).show();
					}
					}else{
					}
			...
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(DormListViewActivity4.this, result, Toast.LENGTH_SHORT).show();;
		} catch (IOException e) {
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(DormListViewActivity4.this, result, Toast.LENGTH_SHORT).show();;
	...
	public void loadingGoodsListData(String key){
		...
		String url = HttpUtil.URL_DORMLST_LOUHAO+"louhao="+key;
		HttpPost request = HttpUtil.getHttpPost(url);
		String result = null;
		try {
			// 获得响应对象
