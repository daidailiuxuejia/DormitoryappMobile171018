 ...
 */
public class StudentListViewActivity2 extends Activity implements OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myApp =  (MyApp) StudentListViewActivity2.this.getApplication();
		keyword = StudentListViewActivity2.this.getIntent().getStringExtra("keyword");
		...
		adapter =  new StudentListViewAdapter(StudentListViewActivity2.this);
...
//		loadingGoodsListData(null);
	...
	private void ShowSureDialog(final String roomid) {
		final AlertDialog alertDialog = new AlertDialog.Builder(StudentListViewActivity2.this)
				.setTitle("确认信息")
				.setMessage("确认取消本次预定？")
...
//					JSONObject obj = new JSONObject(json);
					...
					if(arrlist.equals("1")){
						Toast.makeText(StudentListViewActivity2.this, "取消成功", Toast.LENGTH_LONG).show();
//						loadingGoodsListData();
					}
					}else{
					}
			...
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(StudentListViewActivity2.this, result, Toast.LENGTH_SHORT).show();;
		} catch (IOException e) {
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(StudentListViewActivity2.this, result, Toast.LENGTH_SHORT).show();;
	...
	public void loadingGoodsListData(String key){
		...
		String url = HttpUtil.URL_STUDENTLST+"?xuehao="+key;
		HttpPost request = HttpUtil.getHttpPost(url);
		String result = null;
		try {
			// 获得响应对象
